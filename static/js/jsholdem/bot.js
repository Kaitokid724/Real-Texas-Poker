/*
La parte mas dificil, darle cualidades de jugadores reales a los bots
es algo complicado pero me basare en juegos de poker transmitidos en años anteriores
por ESPN.
*/
...
function internal_setup () 
{
  ...
  if (NUM_IN_GAME > 3) {
    ...
    SMALL += 5;
    MED = internal_round5(CALL + 0.1 * BANKROLL);
    BIG = internal_round5(CALL + 0.2 * BANKROLL);
  }
  ALLIN = BANKROLL;
}
